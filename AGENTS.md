...
**Правила:**
- Первичный язык документации: русский, английский — в README.md параллельно
- Диаграммы: формат Mermaid, файлы в `docs/diagrams/`
- При изменении API обязательно обновить OpenAPI-спецификацию (`docs/openapi.yaml`)
...
- Целевые метрики: p95 latency `/classify` < 500ms, memory < 100MB per request
